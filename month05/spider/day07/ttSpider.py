...
class TTLogin():
    def __init__(self):
        ...
        self.driver.get(url='http://www.ttshitu.com/login.html?spm=null')
    ...
    def get_image(self):
        ...
        img_node = self.driver.find_element_by_xpath('//*[@id="captchaImg"]')
        locate = img_node.location
        left_x = locate['x']
        left_y = locate['y']
        # size属性: 获取节点的宽度width和高度height
        img_size = img_node.size
        right_x = left_x + img_size['width']
        right_y = left_y + img_size['height']
        # 截取图片
    ...
    def crawl(self):
        ...
        self.driver.find_element_by_xpath('/html/body/div/div/div[2]/form/button').click()
